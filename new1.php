...
<canvas id="canvas"></canvas>
  ...
  <br>
  <ul>
  <!--li><a href="cot.html">&nbsp &nbsp &nbsp &nbsp Parsec</a></li--> 
  ...
  <li style="background-color:green;"><a href="#">WHAT'S NEW </a> &nbsp &nbsp &nbsp &nbsp  </li>
  <li><a href="viewprofile.php">CHECK PROFILE</a> &nbsp &nbsp &nbsp &nbsp  </li>
...
<div class="table">
  <div class="table-cell">
    <div class="container">
      ...
      <div class="container-info">
        <h1>
			<span style="font-size:20px;"> Parsec , </span>
			<br><span class='info1' style='line-height:10%;font-size:14px;'> Admin powers can be extended to: monitor the quiz,handle the profile,add new records and post new stories in the timeline via (not yet developed) blog.<span>
        </h1>
      </div>
    </div>
  </div>
